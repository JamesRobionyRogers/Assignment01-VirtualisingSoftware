...
import { Breadcrumbs, Timeline, TimelineBody, TimelineConnector, TimelineHeader, TimelineIcon, TimelineItem } from '@material-tailwind/react';
...
export default function Application({ application, actionData }: { application: ApplicationData, actionData: { error: string, success: string } }) {
                    ...
                    <div className="flex flex-row gap-5 min-w-0 flex-1">
                        <h2 className="w-full text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                            <input
                                name="job"
                                type="text"
                                defaultValue={applicationData.job}
                            ...
                            <TimelineItem>
                                ...
                                <TimelineHeader>
                                    ...
                                    <div className="flex flex-row items-center gap-1 ">
                                        ...
                                        <p>on the {formatDate(selectedDate ?? new Date())}</p>
                                    </div>
                                </TimelineHeader>
